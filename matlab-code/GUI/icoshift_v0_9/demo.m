...
[AlignedWineData, intervals, indexes] = icoshift ('average', X, wine_ints, 'f', [2 1 0]);

%% iCOshift 4a: Like the previous example but using an intermediate "coshift" step

[AlignedWineData, intervals, indexes] = icoshift ('max', X, wine_ints, 'f', [2 1 1]);
set(gca,'Xlim',[7151 7550], 'Ylim', [-100 9e06]);


%% iCOshift 4b: Like the previous example but using missing values for the last setp

[AlignedWineData, intervals, indexes] = icoshift ('max', X, wine_ints, 'f', [2 0 1]);
set(gca,'Xlim',[7151 7550], 'Ylim', [-100 9e06]);
